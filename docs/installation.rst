...
The sources for datafuzz can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/kjam/datafuzz
.. _tarball: https://github.com/kjam/datafuzz/tarball/master
